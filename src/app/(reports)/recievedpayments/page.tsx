...
const Recievedpayments = () => {
  ...
  const header = ["customerName", "invoiceNumber", "invoiceDate","Total","paymentMode",];
            ...
            >
              <div className="w-full text-white flex justify-center ">
                <div className="text-center">
                  ...
                  <h1 className="text-[22px]">Payments Recieved Sales</h1>
              ...
              <div className="w-full px-3 flex flex-col items-center">
                ...
                <tr className="border-b border-white" key={item.id}>
                  ...
                  <Link href={`/edititem/${item.id}`}><td className="p-2 text-center">edit</td></Link>
                    ...
                    {recievedpayments.map((item: any, index: Number) => (
                      <tr
                ...
                {recievedpayments.length==0 && <EmptyDataReport />}
